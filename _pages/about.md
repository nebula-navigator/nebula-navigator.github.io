...
<div class="page-content" style="display: flex; justify-content: space-between; margin: 20px; gap: 20px;">
    ...
    <figure style="text-align: center; flex: 1; max-width: 100%;">
        <img src="./images/newplot.png" alt="Phase-folded lightcurve from Tarleton" style="width: 100%; max-width: 800px; height: 800px;"/>
...
<div style="margin-top: 20px; text-align: center;">
    <iframe src="./images/scatter_plot.html" style="width: 120%; max-width: 1600px; height: 1000px; border: none;"></iframe>
</div>
