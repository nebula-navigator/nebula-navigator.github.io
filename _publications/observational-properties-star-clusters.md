...
<!-- First Row -->
<div class="page-content" style="display: flex; justify-content: space-around; gap: 20px;">
    <!-- Left side figure -->
    ...
    <!-- Right side figure -->
    <figure style="text-align: center; flex: 1; max-width: 80%;">
        <img src="/images/esdist.png" alt="Another lightcurve or figure" style="width: 100%; max-width: 1200px; height: auto;"/>
        <figcaption style="margin-top: 10px; font-size: 1.1em; font-weight: bold;"></figcaption>
    </figure>
</div>
